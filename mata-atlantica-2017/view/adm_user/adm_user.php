...
<body>
	...
	<?php require_once 'header_adm_user.php'; ?>
	...
	<main class="margin-top">
		...
		<div class="row">
			<div class="col s12">
				<h5 class="header"><blockquote>Denúncias</blockquote></h5>
			</div>	
		</div>
		...
		<ul class="collapsible popout" data-collapsible="accordion">
			<li>
				...
				<div class="collapsible-body">
					...
					<div class="left">
						<a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Aprovado" href=""><i class="material-icons">thumb_up</i></a>
						<a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Negado" href=""><i class="material-icons">thumb_down</i></a>						
					</div>
			...
			<li>
				<div class="collapsible-header"><i class="material-icons green-text text-darken-4">gps_fixed</i>#20171002 - Desmatamento Ilegal
					<span class="badge red-text"></span>
					<i class="material-icons right">attach_file</i>
				</div>
				<div class="collapsible-body">
